    ...
    <div style={styles.page}>
      ...
      <nav style={styles.nav}>
        ...
        <div style={styles.navRight}>
          ...
          {/* ✅ Admin button is NOW inside the nav */}
      ...
      <div style={styles.container}>
        ...
        <div style={styles.cardsGrid}>
          ...
          <div style={styles.card} onClick={() => navigate("/resumes")}>
            <div style={styles.cardImgWrapper}>
              <img src="https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=600&q=80" alt="Resume" style={styles.cardImg} />
          ...
          <div style={styles.card} onClick={() => navigate("/interview")}>
            <div style={styles.cardImgWrapper}>
              <img src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=600&q=80" alt="Interview" style={styles.cardImg} />
              <div style={styles.cardImgOverlay}>
        ...
        <div style={styles.stepsGrid}>
          {[
            { num:"1", title:"Create Account", desc:"Sign up in 30 seconds and access all AI tools for free.", img:"https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=400&q=80", color:"#ede9fe" },
            { num:"2", title:"Upload Resume", desc:"Upload your PDF or Word resume to our secure platform.", img:"https://images.unsplash.com/photo-1568219656418-15c329312bf1?w=400&q=80", color:"#dbeafe" },
            { num:"3", title:"Get AI Score", desc:"Our AI analyzes and scores your resume instantly.", img:"https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400&q=80", color:"#dcfce7" },
            { num:"4", title:"Ace Interview", desc:"Practice mock interviews and land your dream job.", img:"https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=400&q=80", color:"#fef3c7" },
          ].map((s, i) => (
        ...
        <div style={styles.tipsSection}>
          <div style={styles.tipsLeft}>
            <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=600&q=80" alt="Tips" style={styles.tipsImg} />
          </div>
        ...
        <div style={styles.testimonialsGrid}>
          {[
            { name:"Sarah Johnson", role:"Software Engineer", text:"The AI feedback helped me improve my resume score from 62 to 91! I got 3 interview calls the next week.", img:"https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80", score:"91/100" },
            { name:"Michael Chen", role:"Product Manager", text:"Mock interviews helped me prepare for tough questions. I felt confident and landed my dream job at a top company.", img:"https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80", score:"88/100" },
            { name:"Priya Patel", role:"Data Analyst", text:"Amazing tool! The detailed AI feedback showed me exactly what was missing in my resume. Highly recommended!", img:"https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&q=80", score:"94/100" },
          ].map((t, i) => (
...
const styles = {
  ...
  adminBtn: { padding:"8px 20px", background:"#ede9fe", color:"#6d28d9", border:"none", borderRadius:"8px", cursor:"pointer", fontWeight:"600", fontSize:"14px" },
